    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <a href="{{ \Vmorozov\LaravelAdminGenerator\App\Utils\UrlManager::listRoute($url) }}">
                <i class="fa fa-angle-double-left"></i> {{ __(\Vmorozov\LaravelAdminGenerator\AdminGeneratorServiceProvider::VIEWS_NAME.'::base.back_to_list') }} <span>{{ $titlePlural or '' }}</span>
            </a>
            ...
            <form id="entity_form"
                  method="POST"
                  action="{{ \Vmorozov\LaravelAdminGenerator\App\Utils\UrlManager::createRoute($url) }}"
